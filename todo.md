...
- on document delete: see if any page has this page as parent. if so, intercept delete and inform user, that breadcrumb on these pages will be removed. if agreed, then remove the breadcrumb on these pages!!
