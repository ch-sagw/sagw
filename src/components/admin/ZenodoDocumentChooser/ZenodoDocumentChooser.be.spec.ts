...
test.describe('Add Zenodo document', () => {
  ...
  test.beforeEach(async ({
    ...
    await page.goto('http://127.0.0.1:3000/admin/collections/zenodoDocuments/create');
  ...
  test('returns proper api structure', async ({
    ...
    const res = await fetch('http://127.0.0.1:3000/api/zenodoDocuments?where[zenodoId][equals]=15126911');
