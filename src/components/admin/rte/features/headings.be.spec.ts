...
/*
  rte content with h1, h2, h3, h4, h5 and some text in between, to test
  to check correct heading level rendering
*/
const rteContent = {
  root: {
...
/*
  rte content with h1, h2, h3, h4, h5 and some text in between. All headings
  have the same text, to test proper id generation
*/
const rteContent2 = {
  root: {
...
test.describe('heading levels and ids', () => {
  ...
  test('renders proper heading ids', async ({
    page,
  }) => {
    await deleteSetsPages();
